...
const SubscriptionsPage = () => {
  ...
  const [sendNewsletterMutation, { loading: sending }] =
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Dialog
        open={isNewsletterDialogOpen}
        onOpenChange={setIsNewsletterDialogOpen}
      >
        <DialogContent>
          <DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> This will send to{" "}
                {activeSubscriptions.length} active subscribers.
              </p>
            </div>
          </div>
