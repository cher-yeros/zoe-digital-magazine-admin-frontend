...
const MagazineDashboard = () => {
  ...
  const submissionsVariables = useMemo(
    () => ({
      status: "submitted",
      pagination: { limit: 5 },
    }),
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Welcome back, {user?.display_name || "User"}! Here's your magazine
          overview.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            {!topArticlesData?.topArticles ||
            topArticlesData.topArticles.length === 0 ? (
              <p className="text-center text-muted-foreground py-8">
                No data available
              </p>
            ) : (
              <div className="space-y-4">
                {topArticlesData.topArticles.map((item: any, index: number) => (
                  <div
                    ...
                    onClick={() =>
                      navigate(`/admin/articles/${item.article.id}/edit`)
                    }
                  >
                    ...
                    .map((stat: any) => (
                      ...
                      >
                        ...
                        <div className="text-right text-sm">
                          <p className="font-semibold">
                            {stat.total_views.toLocaleString()} views
                          </p>
                          <p className="text-muted-foreground">
